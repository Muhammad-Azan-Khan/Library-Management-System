...
//   // Track mouse position for background glow (if needed)
//   useEffect(() => {
...
//           <h1 className="relative font-black text-4xl lg:text-6xl leading-tight mb-8 text-white ">
...
//             Dive into a world of knowledge where learning never stops. From
//             classic literature to modern educational content, we've curated the
//             finest selection to help you grow, learn, and discover new passions.
//             Every book here is carefully selected to provide you with the best
//             reading experience.
//           </p>
...
//             <h2 className="relative font-black text-3xl lg:text-5xl mb-6 text-white">
//               All{" "}
...
function Course() {
  ...
  // Load liked books for this user
  useEffect(() => {
    // Clean up old key (global)
  ...
  // Save liked books to localStorage (user-wise)
  useEffect(() => {
